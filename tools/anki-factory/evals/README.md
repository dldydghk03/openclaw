...
- Phrasing regressions based on user feedback are caught, including "well matches", "bundle/axis", directional advice, and stiff report prose.
...
- Copilot instruction files must stay inside the instruction budget and keep core rules near the top.
